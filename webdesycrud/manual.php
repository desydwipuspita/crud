...
<div class="container">
		<h2 style=" width: 100%; border-bottom: 4px solid #ff8680"><b>Panduan</b></h2>
	<div class="bs-acc">
			...
			<div class="panel panel-default">
				...
				<div class="panel-heading" style="background-color: #eee;">
					<h4 class="panel-title">
						Bagaimana Cara Membeli Produk Mochicu?
					</h4>
				</div>
				</a>
				<div id="collapseOne" class="panel-collapse collapse in">
					<div class="panel-body">
						<ol>
							...
							<li>Pilih varian yang kamu mau </li>
							<li>Selanjutnya Lakukan Checkout</li>
						</ol>
					</div>
				</div>
			</div>
